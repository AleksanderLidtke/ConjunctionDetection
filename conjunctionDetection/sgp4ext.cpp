...
*							Removed header safeguards and changed those to #pragma once
*    changes :
...
*                           original baseline
*              27 Mar 14 Alek Lidtke
*                           added the compiler flags to use secure functions in MS Visual Studio to suppress warnigns
*       ----------------------------------------------------------------      */
